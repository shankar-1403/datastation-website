...
const ANGEL_INVESTOR_HANDLE = DATA_PRODUCTS.find((p) => p.id === "angel-500")?.handle ?? "top-500-angel-investor-data-india-usa-uae";
...
export default function AngelInvestorPage() {
  ...
  const item = getProductPrice("angel-500");

  const breadcrumbItems = [
    { label: "Home", href: "/app" },
    { label: "Products", href: "/app/products" },
    { label: "Top 500 Angel Investor Data" },
  ];
    ...
    <div className="max-w-full overflow-x-hidden bg-white px-4 pb-20 pt-20 sm:px-6 sm:pt-24 lg:px-8 lg:pt-30 min-[1100px]:px-13">
      <div className="mb-8 space-y-4 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start lg:gap-10">
          ...
          <div className="min-w-0">
            <h1 className="font-heading font-bold leading-[1.1] tracking-tight text-[#ed501f] sm:text-4xl md:text-3xl lg:text-5xl">Top 500 Angel Investor Data (India, USA, UAE)</h1>
      ...
      <div className="pt-10">
        ...
        <DatabaseCarousel excludeProductId="angel-500" />
      </div>
    </div>
  );
}
