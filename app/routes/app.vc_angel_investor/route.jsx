...
const VC_INVESTOR_HANDLE = DATA_PRODUCTS.find((p) => p.id === "vc-250")?.handle ?? "top-250-vc-angel-investors-india";
...
export const loader = async ({ request }) => {
  ...
  return {
    ...
    /** Required for best checkout UX. Example: PUBLIC_SHOPIFY_VC_INVESTOR_VARIANT_ID=1234567890 */
...
export default function VcAngelInvestorPage() {
  ...
  const handleCheckoutRedirect = () => {
    ...
    if (shopifyVcInvestorVariantId) {
      // https://shopify.dev/docs/apps/build/checkout/create-cart-permalinks
      const cartUrl = new URL(`${base}/products/${shopifyVcInvestorVariantId}:1`);
    ...
    <div className="max-w-full overflow-x-hidden pt-30 pb-20 px-4 sm:px-6 lg:px-8 min-[1100px]:px-13 bg-white">
      <div className="mb-8 space-y-4 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start lg:gap-10">
          ...
          <div className="min-w-0">
            <h1 className="font-heading text-3xl font-bold leading-[1.1] tracking-tight text-[#ed501f] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">Top 250+ VC & Angel Investors in India</h1>
