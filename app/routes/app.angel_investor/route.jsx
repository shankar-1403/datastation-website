    ...
    <div className="pt-30 pb-20 min-[1100px]:px-13 bg-white">
      <div className="mb-8 space-y-4 text-sm leading-relaxed">
        ...
        <div className="flex gap-10">
          ...
          <div className="w-[50%]">
            <h1 className="font-heading text-4xl font-bold leading-[1.1] tracking-tight md:text-6xl lg:text-7xl text-[#ed501f]">Top 500 Angel Investor Data (India, USA, UAE)</h1>
            <p className="mt-6 text-lg leading-relaxed text-[#5c5c5c]">The Top 500 Angel Investor Database provides access to a curated dataset of active angel investors from India, the United States, and the United Arab Emirates.</p>
            <p className="mt-6 text-lg leading-relaxed text-[#5c5c5c]">This database is designed for startup founders, venture professionals, and consultants who are looking to connect with investors and explore funding opportunities.</p>
            <div>
