...
const ANGEL_INVESTOR_HANDLE = DATA_PRODUCTS.find((p) => p.id === "angels-500")?.handle ?? "top-500-angel-investor-data";
...
export const loader = async ({ request }) => {
  ...
  return {
    ...
    /** Required for best checkout UX. Example: PUBLIC_SHOPIFY_ANGEL_INVESTOR_VARIANT_ID=1234567890 */
...
export default function AngelInvestorPage() {
  ...
  const handleCheckoutRedirect = () => {
    ...
    if (shopifyAngelInvestorVariantId) {
      // https://shopify.dev/docs/apps/build/checkout/create-cart-permalinks
      const cartUrl = new URL(`${base}/products/${shopifyAngelInvestorVariantId}:1`);
    ...
    <div className="max-w-full overflow-x-hidden pt-30 pb-20 px-4 sm:px-6 lg:px-8 min-[1100px]:px-13 bg-white">
      <div className="mb-8 space-y-4 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start lg:gap-10">
          ...
          <div className="min-w-0">
            <h1 className="font-heading text-3xl font-bold leading-[1.1] tracking-tight text-[#ed501f] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">Top 500 Angel Investor Data (India, USA, UAE)</h1>
            <p className="mt-4 text-base leading-relaxed text-[#5c5c5c] sm:mt-5 sm:text-lg">The Top 500 Angel Investor Database provides access to a curated dataset of active angel investors from India, the United States, and the United Arab Emirates.</p>
            <p className="mt-4 text-base leading-relaxed text-[#5c5c5c] sm:mt-5 sm:text-lg">This database is designed for startup founders, venture professionals, and consultants who are looking to connect with investors and explore funding opportunities.</p>
              ...
              {isEmailVerified && (
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="mt-3 w-full rounded-xl bg-linear-to-r from-[#ed501f] to-[#cf3101] text-white py-3 font-semibold"
                  >
                    Continue to Buy
                  </button>
                </div>
