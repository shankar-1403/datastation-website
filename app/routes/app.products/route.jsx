            ...
            {COLLECTIONS.map((item, i) => (
              <>
                <motion.div
                  ...
                  className="group relative lg:col-span-1 overflow-hidden rounded-3xl border border-border bg-linear-to-br from-[#fff7f4] via-white to-[#fef7f4] p-6 shadow-sm transition-all hover:shadow-lg"
                >
                  ...
                  <Link to={`${item.appPath}${search}`} >
                    ...
                    <div className="relative">
                      ...
                      <div>
                        ...
                        <p className="mt-2 font-heading text-base font-bold w-85 truncate">{item.title}</p>
